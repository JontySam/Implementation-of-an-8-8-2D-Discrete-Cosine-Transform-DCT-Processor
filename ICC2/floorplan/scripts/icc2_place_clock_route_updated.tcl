...
copy_block -force -from_block placement_done.design -to full_chip_${DESIGN_NAME}
...
report_congestion > ./reports_pnr/${DESIGN_NAME}.congestion.rpt 
report_timing   > ./reports_pnr/${DESIGN_NAME}.timing_setup.rpt
...
set TIE_HIGH_CELL "TIEH"
set TIE_LOW_CELL "TIEL"
add_tie_cells -objects [get_pins $eco_pins] -tie_high_lib_cells [get_lib_cell -filter name=~"*$TIE_HIGH_CELL*"] -tie_low_lib_cells [get_lib_cell -filter name=~"*$TIE_LOW_CELL*"]
...
route_detail -incremental true -max_number_iteration 15
